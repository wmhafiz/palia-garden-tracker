...
export const CropWateringItem: React.FC<CropWateringItemProps> = ({
    ...
    return (
        <div
            className={`flex items-center space-x-3 py-2 border-b border-gray-200 last:border-b-0 transition-colors ${onClick ? 'cursor-pointer hover:bg-gray-800/20' : ''
                }`}
            onClick={onClick}
        >
            {/* Crop Image */}
...
export const CompactCropWateringItem: React.FC<CropWateringItemProps> = ({
    ...
    return (
        <div
            className={`flex items-center space-x-2 py-1 transition-colors ${onClick ? 'cursor-pointer hover:bg-gray-800/20' : ''
                }`}
            onClick={onClick}
        >
            {/* Compact Image */}
