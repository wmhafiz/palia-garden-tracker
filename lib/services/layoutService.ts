...
export class LayoutService {
    ...
    private isValidSavedLayout(data: unknown): data is SavedLayout {
        return (
            data &&
            typeof data === 'object' &&
            data !== null &&
            ...
            'id' in (data as any).metadata &&
            typeof (data as any).metadata.id === 'string' &&
            'name' in (data as any).metadata &&
            typeof (data as any).metadata.name === 'string' &&
            'saveCode' in data &&
            typeof (data as any).saveCode === 'string' &&
            'gardenData' in data &&
            (data as any).gardenData &&
            'isFavorite' in data &&
